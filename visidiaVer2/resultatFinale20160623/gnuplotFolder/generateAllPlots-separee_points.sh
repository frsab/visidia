	...
	do 	
		...
		nameALGO+="$algo.txt"
			...
			do
				...
				gnuplot ./gnuplotScript/pointsScripts/single_out_generaleDetectRate.plt         
				gnuplot ./gnuplotScript/pointsScripts/single_out_generaleNbMsg.plt
				gnuplot ./gnuplotScript/pointsScripts/single_out_generaleMemoryConsumption.plt
				...
				mv -f DetectRate.png "./graphique/pointsVersions/detectRATE-separee/${outPNGfileDetectRate}.png"
				mv -f NbMsg.png "./graphique/pointsVersions/nbMSG-separee/${outPNGfileNbMsg}.png"
				mv -f MemoryConsumption.png "./graphique/pointsVersions/memoryCons-separee/${outPNGfileMemoryConsumption}.png"
				done
				#echo "------------------------->${zzFILES}"
