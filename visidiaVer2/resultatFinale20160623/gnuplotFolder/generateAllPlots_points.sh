				...
				do
					...
					do
						...
						do
							...
							gnuplot ./gnuplotScript/pointsScripts/out_generaleDetectRate.plt         
							gnuplot ./gnuplotScript/pointsScripts/out_generaleNbMsg.plt
							gnuplot ./gnuplotScript/pointsScripts/out_generaleMemoryConsumption.plt
							...
							mv -f DetectRate.png "./graphique/pointsVersions/detectRATE/${outPNGfileDetectRate}.png"
							mv -f NbMsg.png "./graphique/pointsVersions/nbMSG/${outPNGfileNbMsg}.png"
							mv -f MemoryConsumption.png "./graphique/pointsVersions/memoryCons/${outPNGfileMemoryConsumption}.png"
							done
						done
					done	
				done
